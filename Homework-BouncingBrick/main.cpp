/* =============================================================
Homework 01: Bouncing Brick
(Based on Intro Code by Mr.Dung)
================================================================ */
...
#define WINDOW_TITLE L"Bouncing Brick"
...
void Update(DWORD dt)
{
	...
	if (brick_y <= 10.0f || brick_y >= BackBufferHeight - BRICK_HEIGHT) {
